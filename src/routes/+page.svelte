...
<div class="my-4 bg-yellow-500/30 border border-neutral-700 shadow p-4 rounded-lg">
...
<div class="flex flex-col md:flex-row gap-4">
  <div class="md:w-1/2 h-max">
    <div class="max-w-96 max-h-96 mx-auto">
...
<textarea rows=10 class="w-full text-black font-mono mt-4">{JSON.stringify(icon, null, 2)}</textarea>